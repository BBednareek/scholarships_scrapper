...
def wydarzenia():
    ...
    url = "https://www.eurodesk.pl/wez-udzial?&whom=&age=&category=26&country="
    ...
    for i in range(min(len(tytuly), len(linki))):
        ...
        img = 'assets/images/wydarzenie.svg'
        ...
        for j in description:
            opis = j.text.strip()
            dodajWydarzenieEuroDesk(kategoria, img, tytul, organizator, tematyka, zasieg, odbiorca, termin, link, opis)
