from Scrapping.Functions.MojeStypendium.insertData import dodajStypendiumMojeStypendia
...
def stypendia_mojestypendia():
    ...
    for page in range(1, pages + 1): #Przechodzimy przez kazda strone
        ...
        for i in range(min(len(tytuly), len(organizatorzy))):
            ...
            img = 'assets/images/stypendium.svg'
            ...
            dodajStypendiumMojeStypendia(kategoria, img, tytul, organizator, tematyka, zasieg, odbiorca, termin, link, opis, sortowanie)
