...
query = "SHOW TABLES LIKE 'konkursy'"
cursor.execute(query)
result = cursor.fetchall()

if result:
    query = "DROP TABLE konkursy"
    cursor.execute(query)
    conn.commit()
    ...
    def appendKonkursy(tytul: str, organizator: str, rodzaj: str, zasieg: str, grupa: str, termin: str, link: str):
        try:
            query = "INSERT INTO konkursy (tytul, organizator, rodzaj, zasieg, grupa_docelowa, termin, link) values(%s, %s, %s, %s, %s, %s, %s)"
